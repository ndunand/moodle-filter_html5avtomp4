...
$settings->add(new admin_setting_configcheckbox('filter_html5avtomp4/deleteoriginalfiles', get_string('deleteoriginalfiles', 'filter_html5avtomp4'), get_string('deleteoriginalfiles_desc', 'filter_html5avtomp4'), false));
